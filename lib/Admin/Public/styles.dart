...
const checkedOutBtnColor   = Color(0xffda3334);
const outPutBackBtnColor   = Color(0xffffc106);
const cancelBtnColor   = Color(0xff0882a8);
const previewBtnColor   = Color(0xff31393d);

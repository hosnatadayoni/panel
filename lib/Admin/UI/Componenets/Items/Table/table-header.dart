                  ...
                  child: PopupMenuButton<int>(
                    ...
                    onSelected: (value) async {
                      setState(() {
                        ...
                        selectedCount = value;
                        MainController.pageInfo[MainController.infoSchema.value.schema.name]!.start = (MainController.infoSchema.value.schema.currentPage-1) * MainController.infoSchema.value.schema.countShowRow;
                        MainController.pageInfo[MainController.infoSchema.value.schema.name]!.end  = MainController.pageInfo[MainController.infoSchema.value.schema.name]!.start!  + int.parse('${MainController.infoSchema.value.schema.countShowRow}');

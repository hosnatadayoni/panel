...
import 'package:finance/Admin/UI/Views/Access/edit-access.dart';
...
import 'create-access.dart';

class TableAccess extends StatefulWidget {
  @override
  State<TableAccess> createState() => _TableAccessState();
}

class _TableAccessState extends State<TableAccess> {
  @override
                                      ...
                                      PopupMenuItem(
                                          onTap: () {
                                            ...
                                            Future.delayed(Duration.zero,
                                              ...
                                              await AdminController.getNameAccess();
                                              Get.to(CreateAccess());
                                            });
                                          },
                                          value: 'create',
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () async {
                                await ConncetServerController.deleteRoute(
                                    data['_id']);
                                Navigator.pop(context);
                              },
                              child: Container(

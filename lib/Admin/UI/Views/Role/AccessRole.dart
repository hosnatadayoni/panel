...
class _TableRoleAccessState extends State<TableRoleAccess> {
                                    ...
                                    rows.value = (AdminController.getAccessRes)
                                      ...
                                      return TableRow(
                                        children: [
                                          ...
                                          CheckBoxItem(row['_id'], 'show'),
                                          CheckBoxItem(row['_id'], 'store'),
                                          CheckBoxItem(row['_id'], 'edit'),
                                          CheckBoxItem(row['_id'], 'delete'),
                                        ],
                                      );
                                    }).toList();
  ...
  Widget CheckBoxItem(var id, var name) {
    bool value = AdminController.accessRoles.length != 0 &&
            AdminController.accessRoles[id] != null
        ? AdminController.accessRoles[id][name]
        : false;
    return Padding(
      ...
      child: CheckBox(
        ...
        onChange: (val) {
          ...
          value = !value;
          if (AdminController.accessRoles.length != 0 &&
              AdminController.accessRoles[id] != null) {
            AdminController.accessRoles[id][name] =
                !AdminController.accessRoles[id][name];
            AdminController.storeRoleAccesss(
                {"item": json.encode(AdminController.accessRoles[id])});
          } else {
            var json = {
              'role_id': widget.data['_id'],
              'access_id': id,
              "$name": value,
              "api_key":MainController.apiKey.value
            };
            AdminController.storeRoleAccesss({"item":jsonEncode (json)});
          }
          setState(() {});
        },
      ),
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Txt('${AdminController.countShowRowRole.value}',
                                      fontSize: 14,
                                      fontWeight: FontWeight.w700,
                                      color: MainController.isLightMode.value ==
                                              true
    ...
    return MouseRegion(
      ...
      child: InkWell(
        onTap: () async {
          ...
          print(
              '_TableFooterState.box currentPage>>>${AdminController.currentPageRole.value}');
          await AdminController.getRoles();
        },
        child: Container(
              ...
              return Container(
                decoration: BoxDecoration(
                  ...
                  color: isHover.value == true
                      ? colorBtn
                      : i == AdminController.currentPageRole.value
                          ? colorBtn
                          : Colors.blue,
                ),
                child: Center(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: AdminController.currentPageRole.value > 1
                        ? () async {
                            setState(() {
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(Radius.circular(5)),
                    color: AdminController.currentPageRole.value < totalPages
                        ? color3
                        : color7,
                  ),
                  child: Container(
                    child: ElevatedButton(
                      style:
                          ElevatedButton.styleFrom(padding: EdgeInsets.all(15)),
                      onPressed:
                          AdminController.currentPageRole.value < totalPages
                              ? () async {
                                  setState(() {
                                    AdminController.currentPageRole.value++;
                                  });

...
class TableRoleAccess extends StatefulWidget {
  TableRoleAccess({this.data});
  var data;
  @override
  State<TableRoleAccess> createState() => _TableRoleAccessState();
}

class _TableRoleAccessState extends State<TableRoleAccess> {
  @override
                  ...
                  children: [
                    ...
                    LayoutBuilder(builder: (context, constraints) {
                      ...
                      return Obx( () {
                        ...
                        rows.value = (AdminController.getAccessRes)
                            .map<TableRow>((row) {
                          return TableRow(
                            children: [
                              Padding(
                              ...
                              Padding(
                                ...
                                child:Checkbox(
                                  value: true,
                                  onChanged: (val) {
                                    // setState(() => editChecked = val ?? false);
                                  },
                                ),
                              ),  Padding(
                                padding: const EdgeInsets.all(8),
                  ...
                  child: PopupMenuTheme(
                    ...
                    child: PopupMenuButton<int>(
                      ...
                      onSelected: (value) async {
                        ...
                        selectedCount = value;
                        MainController.startIndex.value = (AdminController.currentPageRole.value-1) * AdminController.countShowRowRole.value;
                        MainController.endIndex.value = MainController.startIndex.value +AdminController.countShowRowRole.value;
                  ...
                  child: PopupMenuTheme(
                    ...
                    child: PopupMenuButton<int>(
                      ...
                      onSelected: (value) async {
                        ...
                        AdminController.countShowRowRole.value = value;
                        selectedCount = value;
                        MainController.startIndex.value = (AdminController.currentPageRole.value-1) *10;

...
import 'AccessRole.dart';
import 'create-role.dart';
import 'edit-role.dart';

class TableRole extends StatefulWidget {
  @override
  State<TableRole> createState() => _TableRoleState();
}

class _TableRoleState extends State<TableRole> {
  @override
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () async {
                                await AdminController.deleteRole(data['_id']);
                                Navigator.pop(context);
                              },
                              child: Container(
                                padding: EdgeInsets.all(15),
                ...
                child: Container(
                  child: Row(
                    children: [
                      ...
                      Txt('${AppController.of(context)!.value('access')}',
...
class TableHeaderRole extends StatefulWidget {

  @override
  State<TableHeaderRole> createState() => _TableHeaderRoleState();
}

class _TableHeaderRoleState extends State<TableHeaderRole> {
                    ...
                    child: PopupMenuButton<int>(
                      ...
                      onSelected: (value) async {
                        // setState(() {
                          ...
                          selectedCount = value;
                          MainController.pageInfo[tableName]!.start = (AdminController.currentPageRole.value-1) * AdminController.countShowRowRole.value;
                          MainController.pageInfo[tableName]!.end = MainController.pageInfo[tableName]!.start! +AdminController.countShowRowRole.value;
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Obx(() {
                                return Txt('${AdminController.countShowRowRole.value}' , fontSize: 14 , fontWeight: FontWeight.w700, color: MainController.isLightMode.value == true? whiteColor : color1);
                              }
                            ),
                          ],
                        ),
                  ...
                  child: PopupMenuTheme(
                    ...
                    child: PopupMenuButton<int>(
                      ...
                      onSelected: (value) async {
                          ...
                          AdminController.countShowRowRole.value = value;
                          selectedCount = value;
                          MainController.pageInfo[tableName]!.start = (AdminController.currentPageRole.value-1) *10;
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.arrow_drop_down_sharp , size: 20, color:  color1,),
                            SizedBox(width: 5,),
                            Txt('${AdminController.countShowRowRole.value}' , fontSize: 14 , fontWeight: FontWeight.w700, color: MainController.isLightMode.value == true? whiteColor : color1),
                          ],
                        ),
                      ),
                    ),
...
class TableFooterRole extends StatefulWidget {

  @override
  State<TableFooterRole> createState() => _TableFooterRoleState();
}
String tableName='role'+'_'+MainController.apiKey.value;
  ...
  Widget build(BuildContext context) {
    ...
    return Obx((){
      return Container(
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: pagenationBox(MainController.pageInfo[tableName]!.totalRecords , tableSelected),
        ) :
        Column(
            ...
            child: Obx((){
              return Container(
                decoration: BoxDecoration(
                  ...
                  color:isHover.value == true  ? colorBtn:i ==AdminController.currentPageRole.value ? colorBtn : Colors.blue,
                ),
          ...
          child: Row(
            children: [
              Txt('${AppController.of(context)!.value('show')}',
                ...
                fontWeight: FontWeight.w400,
                color: color3,),
              Txt('${AdminController.getRoleRes.value.length == 0
                  ? 0
        ...
        children: <Widget>[
          Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.all(
                  Radius.circular(5)),
              color: AdminController.currentPageRole.value > 1
                  ? color3
                  : color7,
            ),
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                  padding: EdgeInsets.all(15)),
              onPressed: AdminController.currentPageRole.value > 1 ? () async {
                setState(() {
                  AdminController.currentPageRole.value--;
                });
                // MainController.tableData.value= await DB('${tableSelected}').paginate();
              } : null,
              child: Txt('${AppController.of(context)!.value(
                  'previous')}', color: AdminController.currentPageRole.value > 1
                  ? whiteColor
                  : color3),
            ),
          ),
          ...
          Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.all(
                  Radius.circular(5)),
              color: AdminController.currentPageRole.value <
                  totalPages
                  ? color3
                  : color7,
            ),
            child: Container(
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.all(15)),
                onPressed: AdminController.currentPageRole.value <
                    totalPages ? () async {
                  setState(() {
                    AdminController.currentPageRole.value++;
                  });

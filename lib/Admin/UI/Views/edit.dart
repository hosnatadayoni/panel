                  ...
                  child: ColumnScroll(
                    children: [
                      ...
                      if (MainController.selectedSubItem.value != -1)
                        if (MainController.SubMenuList[
                                MainController.selectedSubItem.value]['view'] !=
                            'custom')
                          Container(
                                ...
                                children: [
                                  ...
                                  Btn(
                                      ...
                                      onClick: () async {
                                        ...
                                        // if(parent.length==0) {
                                        print(
                                            '_EditPageState.build>>>${ViewController.request}');
                                        await DB(
                                        ...
                                        // }
                                        // else{
                                        //   await DB('${MainController.tableInfo['schema']['name']}').parent(parentTable: '${parent['parent_table']}',parentId:'${parent['parent_id']}' ).where('_id', '\$eq', '${widget.data!['_id']}')
                                        //       .updateRecords(ViewController.request);
                                        // }

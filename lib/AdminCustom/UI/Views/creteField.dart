...
class _CretePageFieldState extends State<CretePageField> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var j = 0; j < MainController.tableInfo['columns'].length; j++){
      print('tttttttttttt>>>${MainController.tableInfo['columns'][j]}');
    }
    return Scaffold(
      body: Container(
          width: size.width,
                              ...
                              children: [
                                for (var j = 0; j < MainController.tableInfo['columns'].length; j++)
                                 if (MainController.tableInfo['columns'][j]['is-show-store'] == true)
                                  ...
                                  ViewController.generateFormCheckBox(MainController.tableInfo['columns'][j], false.obs)
                                  ...
                                  else if(MainController.tableInfo['columns'][j]['type'] == 'file' || MainController.tableInfo['columns'][j]['type'] == 'multifile')
                                      ...
                                      ViewController.generateFormTimeBox(MainController.tableInfo['columns'][j], TimeOfDay.now(), false.obs)
                                            ...
                                            MainController.tableInfo['columns'][j]['name'] == 'source_table' ? sourceItem.value == 'custom' ? Container() :selectedType.value == 'select' ||selectedType.value == 'multiSelect'  || selectedType.value == 'radiobutton' ||selectedType.value == '' ? Obx((){
                                            ...
                                            Container()
                                                ...
                                                sourceItem.value == 'custom' && (selectedType.value == 'select' ||selectedType.value == 'multiSelect'  || selectedType.value == 'radiobutton')?ViewController.generateFormTextField(GlobalKey(), MainController.tableInfo['columns'][j], 'string', '') :

...
//
//               if (list[j]!.oprator == '==') {
//                 print('d45>>>${d['${list[j]!.fieldName}']}');
//                 print('a6>>>${list[j]!.value}');
...
//         data: request,
//       );
//       print('record order item>>>${record.data}');
//       var beforeValidate =
...
//             for(var Data in dataController.allData.value){
//               print('Data.id>>>${Data.id}');
//
//             }
...
//             print('customUpdate>>>${customUpdate.data}');

...
class Btn extends StatefulWidget {
  ...
  final Color? hoverPrimaryTypeColor;
  final bool isLink;
...
class _BtnState extends State<Btn> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isVerticalLayout =
        widget.responsive && size.width < (widget.responsiveBreakpoint ?? 768);
    return Center(
      child: MouseRegion(
        ...
        child: IgnorePointer(
          ...
          child: Focus(
            ...
            child: Container(
              ...
              width: widget.isBlock == true ? size.width : null,margin: isVerticalLayout
                ? EdgeInsets.only(bottom: 8) // فاصله عمودی در حالت ستونی

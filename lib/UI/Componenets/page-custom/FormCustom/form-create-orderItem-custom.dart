                      ...
                      MouseRegion(
                        ...
                        child: InkWell(
                          onTap: () async{
                            ...
                            for (var j = 0; j < subMenu['columns'].length; j++) {
                              isValidator = await ValidatorController.checkInputValidation(j,newData.data ,  tableData: subMenu);
                            ...
                            if(isExsistsValidation){
                              ...
                              // await MainController.loadData(tableData: subMenu);
                              MainController.renderPagination(table: subMenu);
                              // }
                        ...
                        Column(
                          ...
                          Column(
                            ...
                            Column(
                              ...
                              children: [
                                Obx(() {
                                  print('cderty>>>${subMenu['columns'][j]['items']}');
                                  return Txt(
                                    '${subMenu['columns'][j]['name']}',
                                    color: MainController.isLightMode.value == true ? whiteColor : color2,
                                  );

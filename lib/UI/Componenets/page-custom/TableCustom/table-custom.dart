          ...
          child: Scrollbar(
            ...
            child: SingleChildScrollView(
              ...
              child: Table(
                ...
                defaultColumnWidth: FixedColumnWidth((columnList.length > 8
                    ? 200.0
                    : size.width / (columnList.length + 1))),
                ...
                children: [
                  ...
                  for (var i = MainController.startIndex.value;
                      i < MainController.endIndex.value;
                      i++)
                            ...
                            if (columnList[j]['type'] == 'string' ||
                              ...
                              Center(
                                child: Container(
                                  ...
                                  child: CheckBox(
                                    checkBoxName:
                                        '${MainController.tableData.value[i].data[columnList[j]['name']]}',
                                    checkBoxTitle: '',
                                    defaultValue: MainController.tableData
                                        .value[i].data[columnList[j]['name']],
                                    onChange: (text) async {
                                      DataModel dataModel =
                                          MainController.tableData.value[i];
                                      dataModel.data[
                                              '${MainController.SubMenuList[MainController.selectedSubItem.value]['columns'][j]['name']}'] =
                                          text;
                              ...
                              Container(
                                padding: EdgeInsets.all(10),
                                child: MainController.tableData.value[i]
                                            .data[columnList[j]['name']] !=
                                        null
                                    ? Center(
                                        child: Container(
                                          width: 50,
                              ...
                              FutureBuilder<String>(
                                  future: ViewCustomController
                                      .getTitleSelectBoxFormCustom(
                                          columnList[j],
                                          MainController.tableData.value[i]),
                                  builder: (BuildContext context,
                                    ...
                                    if (snapshot.connectionState ==
                                      ...
                                      return Txt(
                                          '${AppController.of(context)!.value('error')}');
                                    } else {
                              ...
                              FutureBuilder<String>(
                                  future: ViewCustomController
                                      .getTitleMultiSelctBoxFormCustom(
                                          columnList[j],
                                          MainController.tableData.value[i]),
                                  builder: (BuildContext context,
                                      AsyncSnapshot<String> snapshot) {

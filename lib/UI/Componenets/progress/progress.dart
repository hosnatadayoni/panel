...
//       child: Row(
//         children: [
//           for(var progress in items)
//              Flexible(
//                flex: (progress.value * 100).round(),
//                child: ClipRRect(
...
//                   minHeight: 10,
//                   color: progress.progressBarolor),
//           ),
//              ),
//         ],
//       ),
...
// class ProgressItem {
//    double value;
//    Color? progressBarolor = colorBtn;
//    Color labelColor = whiteColor;
//
//
//   ProgressItem({
//     required this.value,
//     this.progressBarolor,

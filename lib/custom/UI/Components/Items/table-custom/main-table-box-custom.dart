...
import 'package:finance/custom/UI/Components/Items/table-custom/table-custom.dart';
        ...
        children: [
          Obx(() {
            return ColumnScroll(
              children: [
                TableHeader(),
                if (MainController.infoSchema.value.schema.filters!= null && MainController.infoSchema.value.schema.filters!.length != 0)
                  Container(

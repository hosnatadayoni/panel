                  ...
                  for (var i = 0; i < MainController.tableData.length; i++)
                    TableRow(children: [
                      Obx(() {
                        return Center(
                          child: Txt(
                            '${MainController.tableData.value[i]['Input_Code']}',
                            fontSize: 14,
                      ...
                      Obx(() {
                        return Center(
                          child: Txt(
                            '${MainController.tableData.value[i]['Date']}',
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                            color: MainController.isLightMode.value == true
                                ? whiteColor
                      ...
                      Obx(() {
                        return Center(
                          child: Txt(
                            '${MainController.tableData.value[i]['Drawing_Number']}',
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                            color: MainController.isLightMode.value == true
                                ? whiteColor
                      ...
                      Obx(() {
                        return Center(
                          child: Txt(
                            '${MainController.tableData.value[i]['Drawing_Number(customer)']}',
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                            color: MainController.isLightMode.value == true
                                ? whiteColor
                      ...
                      Obx(() {
                        return Center(
                          child: Txt(
                            '${MainController.tableData.value[i]['Picture'] != null ? MainController.tableData.value[i]['Picture'] : ""}',
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                            color: MainController.isLightMode.value == true
                                ? whiteColor
                          ...
                          child: PopupMenuTheme(
                            ...
                            child: PopupMenuButton<String>(
                              ...
                              onSelected: (String value) async {
                                ...
                                var relation = MainController.tableInfo['schema']
                                ['relations'] !=
                                    null
                                    ? MainController.tableInfo['schema']
                                ['relations']
                              ...
                              itemBuilder: (BuildContext context) {
                                return <PopupMenuEntry<String>>[
                                  if (MainController.tableData.value[i]['sync'] ==
                                      'false')
                                    PopupMenuItem<String>(
                                        value: 'refresh',
                                        child: Container(
                                  ...
                                  if (MainController.tableInfo['schema']
                                  ['relations'] !=
                                      null &&
                                      MainController
                                          .tableInfo['schema']['relations']
                                          .length !=
                                          0)

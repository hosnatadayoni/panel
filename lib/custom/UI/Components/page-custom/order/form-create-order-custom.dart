...
class _FormCreateOrderCustomState extends State<FormCreateOrderCustom> {
  ...
  void initState()  {
    ...
    _futureWidget = ViewCustomController.generateStoreFormOrderView(
        ...
        children: [
          ...
          Container(
            ...
            child: SingleChildScrollView(
              ...
              //   children: [
              //   for (var j = 0; j < MainController.tableInfo['columns'].length; j++)
              //     if(MainController.tableInfo['columns'][j]['is_show_store'] == true)
              ...
              //                                   children: [
              //                                     Container(
              //                                       width: MainController.tableInfo['columns'][j]['name'] == 'Customer'  ? 150:100,
              //                                       // height: 100,

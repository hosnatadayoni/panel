                  ...
                  MouseRegion(
                    ...
                    child: InkWell(
                      onTap: (){
                        ...
                        // Get.to(() => TablePage());
                        HelperController.goToTablePage(MainController.menuList[MainController.selectedSubItem.value].schema.name!);
                      },
                      child: Container(
                        padding: EdgeInsets.all(10),
              ...
              child: Container(
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 20,),
                    ViewController.generateEditFileBox(widget.data, MainController.getDetailsOfField('Orders' , 'Picture'),),
                    SizedBox(width: 20,),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [

...
import 'package:finance/custom/UI/Components/Items/Forms/Order/form-txt-field-edit-custom.dart';
...
class _FormEditOrderCustomState extends State<FormEditOrderCustom> {
  ...
  void initState() {
    super.initState();
    file = ViewCustomController.generateEditFileBox(
        widget.data,
        MainController.getDetailsOfField('Orders', 'Picture2'));
  }
                    ...
                    MouseRegion(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          // Get.to(() => TablePage());
                          HelperController.goToTablePage(MainController
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: FormTextField(
                              ...
                              lable: '',
                              initValue:
                                  '${widget.data['Input_Code'] != null ? widget.data['Input_Code'] : ''}',
                              column: MainController.getDetailsOfField(
                                  'Orders', 'Input_Code'),
                              onChange: (text) {
                                widget.data!['Input_Code'] =
                                    int.tryParse('${text}');
                              },
                              isNumberInt: true,
                            ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: FormTextFieldEditCustom(
                              ...
                              lable: '',
                              initValue:
                                  '${widget.data['Drawing_Number'] != null ? widget.data['Drawing_Number'] : ''}',
                              column: MainController.getDetailsOfField(
                                  'Orders', 'Drawing_Number'),
                              data: widget.data,
                              onChange: (text) {
                                widget.data!['Drawing_Number'] =
                                    int.tryParse('${text}');
                              },
                              isNumberInt: true,
                            ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: FormTextFieldEditCustom(
                              ...
                              initValue:
                                  '${widget.data['Drawing_Number(customer)'] != null ? widget.data['Drawing_Number(customer)'] : ''}',
                              column: MainController.getDetailsOfField(
                                  'Orders', 'Drawing_Number(customer)'),
                              lable: '',
                              data: widget.data,
                              onChange: (text) {
                                widget.data!['Drawing_Number(customer)'] =
                                    int.tryParse('${text}');
                              },
                              isNumberInt: true,
                            ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: SelectBox(
                                ...
                                initalValue:
                                    '${widget.data['Type'] != null ? widget.data['Type']['value'] != null ? widget.data['Type']['value'] : '' : ''}',
                                ...
                                hintText: '',
                                isSeleted: widget.data['Type']['value'] != null
                                    ? true.obs
                                    : false.obs,
                                selectedValue: ''),
                          )
                          ...
                          Container(
                              ...
                              child: SelectBoxSearch(
                                  ...
                                  column: MainController.getDetailsOfField(
                                      'Orders', 'Customer'),
                                  items: [
                                    {'_id': '__hint__', 'Name_and_lastName': 'لطفاً یکی از موارد را انتخاب کنید'},
                                  ...
                                  onChanged: (value) async {
                                    if (value != '') {
                                      ViewCustomController.order['Customer'] =
                                          value;
                                      widget.data['Customer']['_id'] = ViewCustomController.order['Customer'];
                                    } else {
                                      ViewCustomController.order['Customer'] =
                                      '';
                                    }
                                    ViewCustomController.isShowAlert.value = await ViewCustomController.showAlretEditOrder(widget.data['Customer']['_id']);
                                  },
                                  hintText: '',
                          ...
                          Container(
                            ...
                            child: DateBox(
                              selectedDate: widget.data['Date'] != null
                                  ? ViewCustomController.parseDate(
                                      '${widget.data['Date']}')
                                  : Jalali.now(),
                              isSeletedDate: widget.data['Date'] != null
                                  ? true.obs
                                  : false.obs,
                              onDateChanged: (date) {

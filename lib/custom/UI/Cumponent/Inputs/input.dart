...
class Input extends StatefulWidget {
  ...
  double? height;
  int lines;
  TextEditingController? controller; // 👈 اضافه شود
  ...
  Color? borderColor;
  Color? hintColor;
  Input({this.lable,this.width=maxItemWidth,this.controller,this.height=55,this.hint,this.initValue=null,this.onChange,this.isNumber=false,this.icon1,this.icon2,this.lines=1,this.align=TextAlign.right,
    this.hasBorder=true,this.hintFontType=fontTypes.text5  ,
    this.radius = 16, this.fontSize = 14 , this.isMobile = false,
    this.onTap , this.isFocused = false , this.hintColor , this.borderColor,this.inputColor
  });
  ...
  void initState() {
    ...
    _textController = widget.controller ??
        TextEditingController(
          text: widget.initValue != null ? widget.initValue.toString() : '',
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        // initialValue: widget.initValue!=''||widget.initValue!=null?'${widget.initValue}':'',
        autofocus: widget.isFocused == true ? true : false,
        controller: _textController, // 👈 اضافه شود
